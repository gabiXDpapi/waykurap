    ...
    <div className="w-full flex flex-col items-center justify-center gap-6 mt-8">
      ...
      {!isComplete && (
        <button
          ...
          className={`group relative flex items-center justify-center gap-3 px-10 py-4 bg-[#5B45FF] text-white rounded-full font-bold text-lg shadow-xl shadow-[#5B45FF]/30 transition-all ${isCapturing ? 'opacity-60 cursor-not-allowed scale-[0.98]' : 'hover:bg-[#4E39E0] hover:scale-[1.02] active:scale-[0.98]'}`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={!isCapturing ? "group-hover:rotate-12 transition-transform" : ""}>
